...
#I HAD TO MANUALLY READ IN A FEW CSVs DUE TO AN ERROR, BUT I DOWNLOADED THEM FROM THE SITES
...
state_test = read.csv("Data/daily.csv")
...
state_test$date_since_social = as.numeric(as.Date(strptime(date_of_study, "%m-%d-%Y")) - 
                                            as.Date((strptime(state_test$stay_at_home, "%m/%d/%Y"))))
...
dat <- aggregate_pm_census_cdc_test_beds
save(dat, file="Data/dat.Rda")

#I COMMENTED THIS OUT BECAUSE IT DID NOT WORK ON MY COMPUTER AND DOES NOT SEEM TO BE A COVARIATE IN THE MAIN MODEL
